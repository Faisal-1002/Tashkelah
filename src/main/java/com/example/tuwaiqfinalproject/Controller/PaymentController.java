...
//    @PostMapping("/puy")
//    public ResponseEntity<?> paymnt(@AuthenticationPrincipal User user, @RequestBody Payment paymentRequest) {
//        return ResponseEntity.status(200).body(paymentService.(user.getId(), paymentRequest));
//    }
}
